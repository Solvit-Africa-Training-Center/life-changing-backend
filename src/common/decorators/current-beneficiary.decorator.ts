...
//       // Check for beneficiaryId in query params or body
//       const beneficiaryId = request.query.beneficiaryId || request.body.beneficiaryId;

//       if (!beneficiaryId) {
//         throw new NotFoundException('Beneficiary ID is required for admin users. Provide beneficiaryId in query or body.');
//       }

//       // ✅ Use the new findBeneficiaryById method
